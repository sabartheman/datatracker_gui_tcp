...
class DataGui(Frame):
	...
	def __init__(self, parent, *args, **kwargs):
		...
		#Label(self, text="PKT TYPE: ").grid(row=12, column=1, sticky=W)
		### VOLTAGES ###
		Label(self, text="VOLTAGE_INS_IN: ").grid(row=13, column=1, sticky=W)
		Label(self, text="VOLTAGE_AVE_IN: ").grid(row=14, column=1, sticky=W)
		Label(self, text="VOLTAGE_MAX_IN: ").grid(row=15, column=1, sticky=W)
		Label(self, text="VOLTAGE_MIN_IN: ").grid(row=16, column=1, sticky=W)
		Label(self, text="VOLTAGE_INS_3V3D: ").grid(row=17, column=1, sticky=W)
		Label(self, text="VOLTAGE_AVE_3V3D: ").grid(row=18, column=1, sticky=W)
		Label(self, text="VOLTAGE_MAX_3V3D: ").grid(row=19, column=1, sticky=W)
		Label(self, text="VOLTAGE_MIN_3V3D: ").grid(row=20, column=1, sticky=W)
		Label(self, text="VOLTAGE_INS_2V5D: ").grid(row=13, column=3, sticky=W)
		Label(self, text="VOLTAGE_AVE_2V5D: ").grid(row=14, column=3, sticky=W)
		Label(self, text="VOLTAGE_MAX_2V5D: ").grid(row=15, column=3, sticky=W)
		Label(self, text="VOLTAGE_MIN_2V5D: ").grid(row=16, column=3, sticky=W)
		Label(self, text="VOLTAGE_INS_1V8D: ").grid(row=17, column=3, sticky=W)
		Label(self, text="VOLTAGE_AVE_1V8D: ").grid(row=18, column=3, sticky=W)
		Label(self, text="VOLTAGE_MAX_1V8D: ").grid(row=19, column=3, sticky=W)
		Label(self, text="VOLTAGE_MIN_1V8D: ").grid(row=20, column=3, sticky=W)
		Label(self, text="VOLTAGE_INS_1V0D: ").grid(row=13, column=5, sticky=W)
		Label(self, text="VOLTAGE_AVE_1V0D: ").grid(row=14, column=5, sticky=W)
		Label(self, text="VOLTAGE_MAX_1V0D: ").grid(row=15, column=5, sticky=W)
		Label(self, text="VOLTAGE_MIN_1V0D: ").grid(row=16, column=5, sticky=W)
		Label(self, text="VOLTAGE_INS_0V95D: ").grid(row=17, column=5, sticky=W)
		Label(self, text="VOLTAGE_AVE_0V95D: ").grid(row=18, column=5, sticky=W)
		Label(self, text="VOLTAGE_MAX_0V95D: ").grid(row=19, column=5, sticky=W)
		Label(self, text="VOLTAGE_MIN_0V95D: ").grid(row=20, column=5, sticky=W)

		### CURRENTS ###
		Label(self, text="CURRENT_INS_IN: ").grid(row=13, column=   7, sticky=W)
		Label(self, text="CURRENT_AVE_IN: ").grid(row=14, column=   7, sticky=W)
		Label(self, text="CURRENT_MAX_IN: ").grid(row=15, column=   7, sticky=W)
		Label(self, text="CURRENT_MIN_IN: ").grid(row=16, column=   7, sticky=W)
		Label(self, text="CURRENT_INS_3V3D: ").grid(row=17, column= 7, sticky=W)
		Label(self, text="CURRENT_AVE_3V3D: ").grid(row=18, column= 7, sticky=W)
		Label(self, text="CURRENT_MAX_3V3D: ").grid(row=19, column= 7, sticky=W)
		Label(self, text="CURRENT_MIN_3V3D: ").grid(row=20, column= 7, sticky=W)
		Label(self, text="CURRENT_INS_2V5D: ").grid(row=13, column= 9, sticky=W)
		Label(self, text="CURRENT_AVE_2V5D: ").grid(row=14, column= 9, sticky=W)
		Label(self, text="CURRENT_MAX_2V5D: ").grid(row=15, column= 9, sticky=W)
		Label(self, text="CURRENT_MIN_2V5D: ").grid(row=16, column= 9, sticky=W)
		Label(self, text="CURRENT_INS_1V8D: ").grid(row=17, column= 9, sticky=W)
		Label(self, text="CURRENT_AVE_1V8D: ").grid(row=18, column= 9, sticky=W)
		Label(self, text="CURRENT_MAX_1V8D: ").grid(row=19, column= 9, sticky=W)
		Label(self, text="CURRENT_MIN_1V8D: ").grid(row=20, column= 9, sticky=W)
		Label(self, text="CURRENT_INS_1V0D: ").grid(row=13, column= 11, sticky=W)
		Label(self, text="CURRENT_AVE_1V0D: ").grid(row=14, column= 11, sticky=W)
		Label(self, text="CURRENT_MAX_1V0D: ").grid(row=15, column= 11, sticky=W)
		Label(self, text="CURRENT_MIN_1V0D: ").grid(row=16, column= 11, sticky=W)
		Label(self, text="CURRENT_INS_0V95D: ").grid(row=17, column=11, sticky=W)
		Label(self, text="CURRENT_AVE_0V95D: ").grid(row=18, column=11, sticky=W)
		Label(self, text="CURRENT_MAX_0V95D: ").grid(row=19, column=11, sticky=W)
		Label(self, text="CURRENT_MIN_0V95D: ").grid(row=20, column=11, sticky=W)

		Label(self, text="A7_TEMPERATURE: ").grid(row=13, column=13, stick=W)
		Label(self, text="PC1_TEMPERATURE: ").grid(row=14, column=13, stick=W)
		Label(self, text="PC2_TEMPERATURE: ").grid(row=15, column=13, stick=W)

		Label(self, text="DAYS: ").grid(row=16, column=   13, sticky=W)
		Label(self, text="HOURS: ").grid(row=17, column=  13, sticky=W)
		Label(self, text="MINUTES: ").grid(row=18, column=13, sticky=W)
		Label(self, text="SECONDS: ").grid(row=19, column=13, sticky=W)
		Label(self, text="CRC: ").grid(row=20, column=13, sticky=W)
	...
	def updateHealth(self,data):
		...
		# 	Label(self, justify=LEFT,wraplength=400, text=format(data[i], "2X")).grid(row=11, column=3+i, sticky=W)

		#Label(self, justify=LEFT, wraplength=800, text=str(data[OFFSET+1])).grid(row=12, column=2, sticky=W)
		### VOLTAGES ###
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[2+OFFSET:4+OFFSET].hex(),16)  /1000)+" V").grid(row=13, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[4+OFFSET:6+OFFSET].hex(),16)  /1000)+" V").grid(row=14, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[6+OFFSET:8+OFFSET].hex(),16)  /1000)+" V").grid(row=15, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[8+OFFSET:10+OFFSET].hex(),16) /1000)+" V").grid(row=16, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[10+OFFSET:12+OFFSET].hex(),16)/1000)+" V").grid(row=17, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[12+OFFSET:14+OFFSET].hex(),16)/1000)+" V").grid(row=18, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[14+OFFSET:16+OFFSET].hex(),16)/1000)+" V").grid(row=19, column=2,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[16+OFFSET:18+OFFSET].hex(),16)/1000)+" V").grid(row=20, column=2,sticky=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[18+OFFSET:20+OFFSET].hex(),16)/1000)+" V").grid(row=13, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[20+OFFSET:22+OFFSET].hex(),16)/1000)+" V").grid(row=14, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[22+OFFSET:24+OFFSET].hex(),16)/1000)+" V").grid(row=15, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[24+OFFSET:26+OFFSET].hex(),16)/1000)+" V").grid(row=16, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[26+OFFSET:28+OFFSET].hex(),16)/1000)+" V").grid(row=17, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[28+OFFSET:30+OFFSET].hex(),16)/1000)+" V").grid(row=18, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[30+OFFSET:32+OFFSET].hex(),16)/1000)+" V").grid(row=19, column=4,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[32+OFFSET:34+OFFSET].hex(),16)/1000)+" V").grid(row=20, column=4,sticky=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[34+OFFSET:36+OFFSET].hex(),16)/1000)+" V").grid(row=13, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[36+OFFSET:38+OFFSET].hex(),16)/1000)+" V").grid(row=14, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[38+OFFSET:40+OFFSET].hex(),16)/1000)+" V").grid(row=15, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[40+OFFSET:42+OFFSET].hex(),16)/1000)+" V").grid(row=16, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[42+OFFSET:44+OFFSET].hex(),16)/1000)+" V").grid(row=17, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[44+OFFSET:46+OFFSET].hex(),16)/1000)+" V").grid(row=18, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[46+OFFSET:48+OFFSET].hex(),16)/1000)+" V").grid(row=19, column=6,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+OFFSET:50+OFFSET].hex(),16)/1000)+" V").grid(row=20, column=6,sticky=W)

		### CURRENTS ###
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+2+OFFSET: 48+4+OFFSET].hex(),16))).grid(row=13, column=  8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+4+OFFSET: 48+6+OFFSET].hex(),16))).grid(row=14, column=  8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+6+OFFSET: 48+8+OFFSET].hex(),16))).grid(row=15, column=  8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+8+OFFSET: 48+10+OFFSET].hex(),16))).grid(row=16, column= 8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+10+OFFSET:48+12+OFFSET].hex(),16))).grid(row=17, column=8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+12+OFFSET:48+14+OFFSET].hex(),16))).grid(row=18, column=8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+14+OFFSET:48+16+OFFSET].hex(),16))).grid(row=19, column=8,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+16+OFFSET:48+18+OFFSET].hex(),16))).grid(row=20, column=8,sticky=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+18+OFFSET:48+20+OFFSET].hex(),16))).grid(row=13, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+20+OFFSET:48+22+OFFSET].hex(),16))).grid(row=14, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+22+OFFSET:48+24+OFFSET].hex(),16))).grid(row=15, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+24+OFFSET:48+26+OFFSET].hex(),16))).grid(row=16, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+26+OFFSET:48+28+OFFSET].hex(),16))).grid(row=17, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+28+OFFSET:48+30+OFFSET].hex(),16))).grid(row=18, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+30+OFFSET:48+32+OFFSET].hex(),16))).grid(row=19, column=10,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+32+OFFSET:48+34+OFFSET].hex(),16))).grid(row=20, column=10,sticky=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+34+OFFSET:48+36+OFFSET].hex(),16))).grid(row=13, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+36+OFFSET:48+38+OFFSET].hex(),16))).grid(row=14, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+38+OFFSET:48+40+OFFSET].hex(),16))).grid(row=15, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+40+OFFSET:48+42+OFFSET].hex(),16))).grid(row=16, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+42+OFFSET:48+44+OFFSET].hex(),16))).grid(row=17, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+44+OFFSET:48+46+OFFSET].hex(),16))).grid(row=18, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+46+OFFSET:48+48+OFFSET].hex(),16))).grid(row=19, column=12,sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[48+48+OFFSET:48+50+OFFSET].hex(),16))).grid(row=20, column=12,sticky=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[98+OFFSET:100+OFFSET].hex(),16))).grid(row=13, column=14, sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[98+OFFSET:100+OFFSET].hex(),16))).grid(row=14, column=14, sticky=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[98+OFFSET:100+OFFSET].hex(),16))).grid(row=15, column=14, sticky=W)

		### RUNTIME ###
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[104+OFFSET:108+OFFSET].hex(),16))).grid(row=16, column=14, stick=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[108+OFFSET:112+OFFSET].hex(),16))).grid(row=17, column=14, stick=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[112+OFFSET:116+OFFSET].hex(),16))).grid(row=18, column=14, stick=W)
		Label(self, justify=LEFT, wraplength=800, text=str(int(data[116+OFFSET:120+OFFSET].hex(),16))).grid(row=19, column=14, stick=W)

		Label(self, justify=LEFT, wraplength=800, text=str(int(data[120+OFFSET:122+OFFSET].hex(),16))).grid(row=20, column=14, stick=W)
